...
public class VDTable: UIView
{
    ...
    public func assembleHorizontalTable(dataCells: [DataCell], headCells: [HeadCell])
    {
    ...
    public func assembleVerticalTable(dataCells: [DataCell], headCells: [HeadCell])
    {
        for view in self.subviews
        {
            view.removeFromSuperview()
...
public class HeadCell
{
    ...
    public init(textValue: String, dimension: CGFloat = -1, fontStyle: String = "Helvetica", fontColor: UIColor = UIColor.black, fontSize: CGFloat = 15, bgColor: UIColor = UIColor.white)
    {
...
public class DataCell
{
    ...
    public init(textValues: [String], fontStyle: String = "Helvetica", fontColor: UIColor = UIColor.black, fontSize: CGFloat = 15, bgColor: UIColor = UIColor.white)
    {
